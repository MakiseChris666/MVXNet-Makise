...
def createAnchors(l: int, w: int, range: Sequence[float], size: Sequence[float]):
    """
    Create a (l, w, 14) anchor
    @param l: Anchor number along the x axis
    @param w: Anchor number along the y axis
    @param range: Range of point cloud
    @param size: Size of a single anchor
    @return: (l, w, 14)
    """
