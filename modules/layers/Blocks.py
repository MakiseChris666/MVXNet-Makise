...
class FCN(nn.Module):
    ...
    def __init__(self, cin, cout):
        ...
        self.bn = nn.BatchNorm2d(cout, affine = cfg.bnaffine, track_running_stats = cfg.bntrack)
...
class CRB3d(nn.Module):
    ...
    def __init__(self, cin, cout, k, s, p):
        ...
        self.bn = nn.BatchNorm3d(cout, affine = cfg.bnaffine, track_running_stats = cfg.bntrack)
